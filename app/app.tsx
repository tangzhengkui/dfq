...
const tokenUrl = decodeURI(decodeURI(window.location.href))
...
const tokenSession = getQuery(tokenUrl)
const tokens = tokenSession.tokenValue;
const tokenName = tokenSession.tokenName
